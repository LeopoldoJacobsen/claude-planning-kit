...
Paste this whole prompt, then add your feature under FEATURE REQUEST at the bottom. Works in any agent; references to subagents/skills degrade gracefully if unavailable (do the work inline instead).
...
<PASTE YOUR FEATURE / TASK / OBJECTIVE HERE — in Portuguese or English>
