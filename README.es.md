...
3. **En el pipeline FULL:** una idea vaga pasa primero por el brainstorming. Después Claude explora el repositorio (discovery), hace **un único lote de preguntas** — normalmente la única pausa antes de la aprobación (la revisión puede añadir una más si un hallazgo exige una decisión de producto) —, escribe el plan dividido en fases y un revisor independiente con contexto limpio valida todo.
